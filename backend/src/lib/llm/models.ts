...
export const CROFAI_MAIN_MODELS = ["deepseek-v4-pro", "kimi-k2.6"] as const;
...
export const CROFAI_MID_MODELS = ["glm-4.7-flash", "qwen3.5-9b"] as const;
...
export const CROFAI_LOW_MODELS = ["qwen3.5-9b"] as const;

export const DEFAULT_MAIN_MODEL = "gemini-3-flash-preview";
export const DEFAULT_TITLE_MODEL = "gemini-3.1-flash-lite-preview";
export const DEFAULT_TABULAR_MODEL = "gemini-3-flash-preview";

const CROFAI_MODELS = new Set<string>([
    ...CROFAI_MAIN_MODELS,
    ...CROFAI_MID_MODELS,
    ...CROFAI_LOW_MODELS,
]);
...
export function providerForModel(model: string): Provider {
    if (CROFAI_MODELS.has(model)) return "crofai";
